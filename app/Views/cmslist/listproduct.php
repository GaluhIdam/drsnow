        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="/Admin/createProduct" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Produk</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                        ...
                        <?php foreach ($id_produk as $row) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/Admin/editProduct/<?= esc($row['id_produk'], 'url') ?>" class="btn btn-primary btn-sm"><i class="fas fa-info-circle"></i> Edit</a>
                                    <a href="/Admin/deleteProduct/<?= esc($row['id_produk']); ?>">
